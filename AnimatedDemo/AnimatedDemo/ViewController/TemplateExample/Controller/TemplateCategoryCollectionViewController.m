...
#import "TemplateCategoryCollectionViewController.h"
...
@interface TemplateCategoryCollectionViewController ()<JXCategoryViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation TemplateCategoryCollectionViewController
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([collectionView isEqual:self.collectionViewArray[0]]) {
        return [[LawyerCollectionViewCell cellSize] CGSizeValue];
    }
    return [[LawyerArticleCollectionViewCell cellSize] CGSizeValue];
}
...
- (void)initUI {
    ...
    for (int i = 0; i < categoryCount; i ++) {
        ...
        if (i == 0) {
            ...
            collectionView.tabAnimated = [TABAnimatedObject animatedWithTemplateClass:[LawyerTemplateCollectionViewCell class]];
        }else {
            ...
            collectionView.tabAnimated = [TABAnimatedObject animatedWithTemplateClass:[CommentTemplateCollectionViewCell class]];
        }
