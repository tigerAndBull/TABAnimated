...
- (void)layoutSubviews {
    ...
    self.typeLab.frame = CGRectMake(CGRectGetMaxX(self.leftImg.frame)+kWidth(12), 0, kWidth(100), kHeight(20));
    self.typeLab.centerY = self.leftImg.centerY;
    
    CGSize size = [self.nameLab getTextSize:CGSizeMake(MAXFLOAT, kHeight(30))];
    self.nameLab.frame = CGRectMake(CGRectGetMinX(self.typeLab.frame), CGRectGetMinY(self.typeLab.frame)-kHeight(30)-5, size.width, kHeight(30));
