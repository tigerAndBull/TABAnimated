//
//  DeleagteSelfSecondExampleViewController.m
//  AnimatedDemo
//
...
#import "DeleagteSelfSecondExampleViewController.h"
...
@interface DeleagteSelfSecondExampleViewController ()

@property (nonatomic,strong) TestTableView *tableView;

@end

@implementation DeleagteSelfSecondExampleViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView tab_startAnimationWithDelayTime:2. completion:^{
        [self afterGetData];
    }];
}
