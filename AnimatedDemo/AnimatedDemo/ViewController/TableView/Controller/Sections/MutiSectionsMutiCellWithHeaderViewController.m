//
//  MutiSectionsMutiCellWithHeaderViewController.m
//  AnimatedDemo
//
...
#import "MutiSectionsMutiCellWithHeaderViewController.h"
...
@interface MutiSectionsMutiCellWithHeaderViewController ()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation MutiSectionsMutiCellWithHeaderViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return [LawyerTableViewCell cellHeight];
}
        ...
        _tableView.tabAnimated.adjustWithClassBlock = ^(TABComponentManager *manager, __unsafe_unretained Class targetClass) {
            if (targetClass == TestTableViewCell.class) {
               ...
               manager.animation(3).down(-5).height(12);
                ...
                manager.animation(2).height(12).down(8).reducedWidth(-90);
            }
        };
    }
    return _tableView;
