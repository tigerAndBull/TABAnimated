...
typedef TABComponentLayer * _Nullable (^TABBaseComponentVoidBlock)(void);
typedef TABComponentLayer * _Nullable (^TABBaseComponentIntegerBlock)(NSInteger);
typedef TABComponentLayer * _Nullable (^TABBaseComponentFloatBlock)(CGFloat);
typedef TABComponentLayer * _Nullable (^TABBaseComponentStringBlock)(NSString *);
typedef TABComponentLayer * _Nullable (^TABBaseComponentColorBlock)(UIColor *);
